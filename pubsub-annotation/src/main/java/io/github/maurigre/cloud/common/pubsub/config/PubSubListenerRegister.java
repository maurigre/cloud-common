...
import io.github.maurigre.cloud.common.pubsub.annotations.PubSubListener;
import io.github.maurigre.cloud.common.pubsub.handlers.PubSubListenerErrorHandler;
...
/**
 * Responsible for registering Pub/Sub listeners during application initialization.
 *
 * <p>This class uses a constructor generated by Lombok's {@code @RequiredArgsConstructor}
 * annotation to initialize the required dependencies.
 */
@Slf4j
@Component
